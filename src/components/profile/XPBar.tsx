...
export const XPBar = memo(({ xp = 0, level = 1 }: { xp: number, level: number }) => {
  ...
  return (
    <div className="w-full space-y-1.5" dir={isRTL ? 'rtl' : 'ltr'}>
      <div className="flex justify-between items-end px-1">
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-[10px] text-game-offwhite/50 font-display uppercase tracking-widest">{t('profile_xp_label')}</span>
        </div>
